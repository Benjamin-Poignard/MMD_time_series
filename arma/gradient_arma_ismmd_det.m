function param_est = gradient_arma_ismmd_det(data,p_lag,q_lag,TT,p,N,sigma)

% Gradient descent (non-stochastic) for ARMA model to obtain ISMMD estimator
% without sampling the innovations at each iteration
