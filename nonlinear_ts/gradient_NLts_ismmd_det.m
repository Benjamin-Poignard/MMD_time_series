function param_est = gradient_NLts_ismmd_det(data,TT,p,N,sigma)

% Gradient descent (non-stochastic) for non-linear MA model to obtain ISMMD 
% estimator without sampling the innovations at each iteration
